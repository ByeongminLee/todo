...
const meta = {
  title: 'DesignSystem/Atom/OrbitingCircles',
...
export const Example: Story = {
  ...
  render() {
    return (
      <div className="relative flex h-[500px] w-[500px] items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
